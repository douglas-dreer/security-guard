...
class VersionManager:
    ...
    def _setup_logging(self, log_file: str, log_level: int):
        ...
        if not self.verbose:  # Só adiciona console handler se não estiver em modo verbose
...
def main():
    ...
    print(" "*20 + "Desenvolvido por: Seu Nome")
    print("="*80 + "\n")
    ...
    version_manager = VersionManager(
        ...
        verbose=args.verbose or True  # Por padrão, mostra mensagens
    )
